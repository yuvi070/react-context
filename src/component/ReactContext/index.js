...
class ReactContext extends Component {
  ...
  render() {
    ...
    console.log(myArray[0].activeLanguage);
        ...
        <div className="home">
          ...
          <div className="body">
            <div className="dropDown">
              <select value={activeLanguage} onChange={this.onChangeLanguage}>
            ...
            <p className="heading2">
              At its most basic level, content marketing is the process of
              creating and sharing relevant, valuable content. Its goal is to
              attract, obtain, and retain your target audience. This includes
              videos, images, and blogs on your business website, social
              platforms, and other outlets to persuade consumers to take action.
              For example, a post on Facebook could showcase the unique benefits
              of a particular product and prompt a reader to click a link to a
              product landing page to learn more.
            </p>
          </div>
        </div>
      </>
